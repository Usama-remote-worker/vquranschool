...
export function TeacherCard({ teacher }: { teacher: Teacher }) {
    return (
        <Card className="overflow-hidden bg-white border border-slate-200 hover:border-blue-300 shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col h-full rounded-3xl group">
            <div className="h-48 bg-gradient-to-b from-blue-900 to-blue-950 flex items-center justify-center relative overflow-hidden">
                ...
                {teacher.profile_photo ? (
                    ...
                    <div className="w-24 h-24 rounded-full bg-white border-4 border-blue-100 flex items-center justify-center text-4xl font-serif text-blue-900 uppercase shadow-lg relative z-10">
            ...
            <CardHeader className="pb-2 pt-6 relative z-10 text-center">
                ...
                {teacher.qualification && (
                    <p className="text-[11px] text-slate-400 mt-1 uppercase tracking-widest">{teacher.qualification}</p>
                )}
            </CardHeader>
